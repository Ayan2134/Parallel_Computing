...
cpp_code_filename = "cosx_mc_parallel.cpp"
cpp_executable = "cosx_mc_parallel"

iteration_list = np.arange(10,100000,5000)
...
plt.title('Error in Monte Carlo Integration vs Number of Iterations')
plt.grid(True)

# Save the plot to a file
plt.savefig('monte_carlo_convergence_plot.png')
